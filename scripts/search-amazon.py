#!/usr/bin/env python3
"""
ny-pay-hub/scripts/search-amazon.py
Amazon Jobs scraper — NY edition.

Strategy: Query amazon.jobs/en/search.json for NY locations.
...
LOG_FILE  = os.path.expanduser("~/ny-pay-hub/scripts/amazon.log")
LOCK_FILE = os.path.expanduser("~/ny-pay-hub/scripts/.amazon.lock")
...
QUERY_LOCATIONS = ['New York, New York, USA', 'New York City, New York, USA', 'Brooklyn, New York, USA', 'Queens, New York, USA']

REGION_TERMS = ['new york', 'nyc', 'manhattan', 'brooklyn', 'queens', 'bronx', 'staten island', 'long island', ', ny']

CITY_MAP = {'new york': 'New York, NY', 'manhattan': 'New York, NY', 'brooklyn': 'Brooklyn, NY', 'queens': 'Queens, NY', 'bronx': 'Bronx, NY'}
...
def main():
    ...
    log("=== Amazon Jobs NY scraper started ===")
    ...
    log(f"=== Amazon NY scraper complete: {total_found} new jobs ===")
    return 0
